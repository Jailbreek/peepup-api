...
-  [_Static Generation (Recommended)_](#static-generation-recommended): The HTML is generated at **build time** and will be reused on each request.
-  [_Server-side Rendering_](#server-side-rendering): The HTML is generated on **each request**.
...
HEREA;
        ...
        $md_decode = base64_decode($dummy->content, true);


        $out = new \Symfony\Component\Console\Output\ConsoleOutput();
        $out->writeln($md_encode);
        $out->writeln("\n");
        echo "=======";
        $out->writeln($md_decode);
